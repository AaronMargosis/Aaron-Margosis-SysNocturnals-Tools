...
|**SysNocturnals Suite**||
|||
|[SysNocturnalsSuite.zip](/releases/latest/download/SysNocturnalsSuite/SysNocturnalsSuite.zip)|All the latest SysNocturnals Tools in one zip file|
...
[Download LUA Buglight](/blob/main/releases/download/SysNocturnalsExtras/LuaBuglight.zip)
...
[Download `The Case of the App Install Recorder`](/blob/main/releases/download/SysNocturnalsExtras/The.Case.of.the.App.Install.Recorder.zip)
...
[Download `IEZoneAnalyzer`](/blob/main/releases/download/SysNocturnalsExtras/IEZoneAnalyzer.3.5.0.5.zip)
